...
public class SuccefullySubmitted extends javax.swing.JFrame {

   
    public SuccefullySubmitted() {
        initComponents();
    }
    
    public SuccefullySubmitted(String marks) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuccefullySubmitted.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuccefullySubmitted().setVisible(true);
            }
        });
    }
